...
var hr13 = document.querySelector(".hr13").getAttribute("data-time");
hr13 = parseInt(hr13.replace("PM", ''))
var h13 = document.querySelector(".h13");

var hr14 = document.querySelector(".hr14").getAttribute("data-time");
hr14 = parseInt(hr14.replace("PM", ''))
var h14 = document.querySelector(".h14");

var hr15 = document.querySelector(".hr15").getAttribute("data-time");
